...
1. Merge or push the commit containing version 2.5.4 to `main`.
2. Complete the Windows/NVDA checks below and record the tested versions.
3. Create and push tag `v2.5.4`. The release workflow builds the package, runs
...
4. Confirm that this permanent direct URL downloads the release asset and ends
   ...
   `https://github.com/ChristosBouronikos/NVDA-Greek-Math/releases/download/v2.5.4/greekMathReader-2.5.4.nvda-addon`
...
<https://github.com/nvaccess/addon-datastore/issues/new?template=registerAddon.yml&title=%5BSubmit+add-on%5D%3A+Greek+Math+Reader+2.5.4&download-url=https%3A%2F%2Fgithub.com%2FChristosBouronikos%2FNVDA-Greek-Math%2Freleases%2Fdownload%2Fv2.5.4%2FgreekMathReader-2.5.4.nvda-addon&source-url=https%3A%2F%2Fgithub.com%2FChristosBouronikos%2FNVDA-Greek-Math&publisher=Bouronikos+Christos&channel=stable&license-name=GPL-3.0-or-later&license-url=https%3A%2F%2Fwww.gnu.org%2Flicenses%2Fgpl-3.0.html>
...
|---|---|
| Download URL | `https://github.com/ChristosBouronikos/NVDA-Greek-Math/releases/download/v2.5.4/greekMathReader-2.5.4.nvda-addon` |
...
Suggested issue title suffix: `Greek Math Reader 2.5.4` (already in the
...
>
> I would kindly like to submit Greek Math Reader 2.5.4, a maintenance update to
...
>
> This update organizes the add-on settings panel into clean, accessible tabs
> (General, Math & Notation, Matrices & Navigation, Rate & Preview, Symbols & Terminology,
> Voices & Tools) and adds a direct download button for Nuance Vocalizer Expressive (Melina / Nikos).
>
...
- [ ] Install `greekMathReader-2.5.4.nvda-addon` in NVDA 2024.1, the oldest
