...
1. Merge or push the commit containing version 2.5.3 to `main`.
2. Complete the Windows/NVDA checks below and record the tested versions.
3. Create and push tag `v2.5.3`. The release workflow builds the package, runs
...
4. Confirm that this permanent direct URL downloads the release asset and ends
   ...
   `https://github.com/ChristosBouronikos/NVDA-Greek-Math/releases/download/v2.5.3/greekMathReader-2.5.3.nvda-addon`
...
<https://github.com/nvaccess/addon-datastore/issues/new?template=registerAddon.yml&title=%5BSubmit+add-on%5D%3A+Greek+Math+Reader+2.5.3&download-url=https%3A%2F%2Fgithub.com%2FChristosBouronikos%2FNVDA-Greek-Math%2Freleases%2Fdownload%2Fv2.5.3%2FgreekMathReader-2.5.3.nvda-addon&source-url=https%3A%2F%2Fgithub.com%2FChristosBouronikos%2FNVDA-Greek-Math&publisher=Bouronikos+Christos&channel=stable&license-name=GPL-3.0-or-later&license-url=https%3A%2F%2Fwww.gnu.org%2Flicenses%2Fgpl-3.0.html>
...
|---|---|
| Download URL | `https://github.com/ChristosBouronikos/NVDA-Greek-Math/releases/download/v2.5.3/greekMathReader-2.5.3.nvda-addon` |
...
Suggested issue title suffix: `Greek Math Reader 2.5.3` (already in the
...
>
> I would kindly like to submit Greek Math Reader 2.5.3, a maintenance update to
...
>
> This update fixes neural voice audio playback where missing channel configuration
> and DLL reference cleanup silenced audio output, resolves the NVDA settings
> panel hanging on OK when selecting the neural synthesizer, and renames the
> synthesizer to "Neural Voices - by Bouronikos hristos".
>
...
- [ ] Install `greekMathReader-2.5.3.nvda-addon` in NVDA 2024.1, the oldest
