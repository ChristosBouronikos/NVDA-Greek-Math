...
This version (2.5.3) ships on the stable channel by explicit maintainer decision. Review gates for the semantic terminology and optional neural voices remain open, tracked in `RELEASE_GATES.md`, `TERMINOLOGY_REVIEW.md`, and `TTS_ENGINE_RESEARCH.md` in the source repository.
