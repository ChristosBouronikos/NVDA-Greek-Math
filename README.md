...
> Απαιτείται NVDA 2024.1 ή νεότερο. Η έκδοση **2.5.3** δηλώνει συμβατότητα έως το NVDA 2026.1.1. Το τελικό φίλτρο ομιλίας Word, που προστέθηκε στην 2.0.0, χρησιμοποιείται ειδικά στο NVDA 2026.1.1· οι παλαιότερες εκδόσεις συνεχίζουν με τις διαθέσιμες διαδρομές παρόχου/TextInfo.

> Η τρέχουσα έκδοση (**2.5.3**) κυκλοφορεί στο σταθερό κανάλι, ύστερα από ρητή απόφαση του συντηρητή. Οι πύλες ελέγχου της νέας σημασιολογικής ορολογίας και των προαιρετικών νευρωνικών φωνών παραμένουν ανοιχτές — δείτε [RELEASE_GATES.md](RELEASE_GATES.md), [TERMINOLOGY_REVIEW.md](TERMINOLOGY_REVIEW.md) και [TTS_ENGINE_RESEARCH.md](TTS_ENGINE_RESEARCH.md).
...
| Παράσταση | Εκφώνηση |
|---|---|
| dy/dx | παράγωγος του γουάι ως προς χι |
| ∂f/∂x | μερική παράγωγος του εφ ως προς χι |
| f′(x) | εφ τόνος του χι |
| ∫₀¹ x² dx | ολοκλήρωμα από 0 έως 1 του χι στο τετράγωνο ως προς χ |
...
|---|---|
| f(x) | εφ του χι |
| f: A → B | συνάρτηση εφ από το έι στο μπί |
...
| ℝ² | ρο στο τετράγωνο |
| ℝⁿ | πραγματικός χώρος νι διαστάσεων |
...
| ∇²f | λαπλασιανή του εφ |
| **a**·**b** | εσωτερικό γινόμενο έι με μπί |
| cross-product(a,b), με `intent` | διανυσματικό γινόμενο έι με μπί |
| exterior-product(a,b), με `intent` | εξωτερικό γινόμενο έι με μπί |
| tensor-product(a,b), με `intent` | τανυστικό γινόμενο έι με μπί |
...
| E[X \| Y] | δεσμευμένη αναμενόμενη τιμή του χι δεδομένου του γουάι |
| X ⫫ Y | χι ανεξάρτητο από γουάι |
| P(A \| B) | πιθανότητα του έι δεδομένου του μπί |
| Var(X) | διακύμανση του χι |
| Cov(X,Y) | συνδιακύμανση των χι και γουάι |
| SD(X) | τυπική απόκλιση του χι |

Θεώρημα του Bayes,
`P(A|B) = P(B|A)P(A)/P(B)`:

> «πιθανότητα του έι δεδομένου του μπί ίσον κλάσμα με αριθμητή πιθανότητα του μπί δεδομένου του έι πιθανότητα του έι, και παρονομαστή πιθανότητα του μπί, τέλος κλάσματος»

Πυκνότητα κανονικής κατανομής,
`f(x) = 1/(σ√(2π)) e^(-(x-μ)²/(2σ²))`:

> «εφ του χι ίσον κλάσμα με αριθμητή 1, και παρονομαστή σίγμα τετραγωνική ρίζα του 2 πι, τέλος κλάσματος ί υψωμένο σε μείον κλάσμα με αριθμητή παρένθεση χι πλην μι κλείνει η παρένθεση στο τετράγωνο, και παρονομαστή 2 σίγμα στο τετράγωνο, τέλος κλάσματος τέλος εκθέτη»

#### Κβαντομηχανική και φυσική

| Παράσταση / πλαίσιο | Εκφώνηση |
|---|---|
| A†, πρότυπο προφίλ | συζυγής ανάστροφος του έι |
| A†, πανεπιστημιακό προφίλ | προσαρτημένος τελεστής του έι |
| A†, κβαντικό πλαίσιο | ερμιτιανός συζυγής του έι |
| ⟨ψ\|φ⟩ | εσωτερικό γινόμενο ψι με φι |
| ⟨ψ\|H\|φ⟩ | στοιχείο πίνακα με μπρα ψι έιτς κετ φι |
| [x,p] = iℏ, κβαντικό πλαίσιο | μεταθέτης των χι και πι ίσον άι ας μπαρ |
| ∇×E = −∂B/∂t | στροβιλισμός του έψιλον ίσον μείον μερική παράγωγος του μπί ως προς ταυ |
...
| `bounded-operator(A)` | φραγμένος τελεστής έι |
...
> «κεφαλαίο τζί με κάτω δείκτες μι νι συν κεφαλαίο λάμδα τζί με κάτω δείκτες μι νι ίσον 8 πι κεφαλαίο ταυ με κάτω δείκτες μι νι»
...
> «ί υψωμένο σε χι ίσον άθροισμα για νι από 0 έως άπειρο του χι στη νιοστή διά νι παραγοντικό»

**Ολοκληρωτικός ορισμός μετασχηματισμού Φουριέ**

`F(ω) = ∫_(-∞)^∞ f(t)e^(-iωt) dt`

> «εφ παρένθεση ωμέγα κλείνει η παρένθεση ίσον ολοκλήρωμα από μείον άπειρο έως άπειρο του εφ του ταυ ί υψωμένο σε μείον άι ωμέγα ταυ ως προς ταυ»

**Ορίζουσα πίνακα 3 επί 3**

`det([[a,b,c],[d,e,f],[g,h,i]])`

> «ορίζουσα του πίνακας 3 επί 3, γραμμή 1: έι, μπί, σί, γραμμή 2: ντί, ε, εφ, γραμμή 3: τζί, έιτς, ι τέλος πίνακα»
...
> «σύστημα 3 εξισώσεων, εξίσωση 1: χι συν γουάι συν ζήτα ίσον 6, εξίσωση 2: 2 χι πλην γουάι συν ζήτα ίσον 3, εξίσωση 3: χι συν 2 γουάι πλην ζήτα ίσον 2 τέλος συστήματος»

**Κυματική εξίσωση ηλεκτρικού πεδίου**

`∇²E − (1/c²)(∂²E/∂t²) = 0`

> «λαπλασιανή του έψιλον πλην 1 διά σί στο τετράγωνο δεύτερη μερική παράγωγος του έψιλον ως προς ταυ ίσον 0»

**Χρονοεξαρτώμενη εξίσωση Schrödinger**

`iℏ ∂ψ/∂t = Ĥψ`

> «άι ας μπαρ μερική παράγωγος του ψι ως προς ταυ ίσον έιτς καπέλο ψι»

**Στοιχείο πίνακα της Χαμιλτονιανής**

`⟨ψ|H|ψ⟩`

> «στοιχείο πίνακα με μπρα ψι έιτς κετ ψι»

**Πλήρης μορφή εξίσωσης πεδίου του Αϊνστάιν**

`G_(μν) + Λg_(μν) = (8πG/c⁴)T_(μν)`

> «κεφαλαίο τζί με κάτω δείκτες μι νι συν κεφαλαίο λάμδα τζί με κάτω δείκτες μι νι ίσον κλάσμα με αριθμητή 8 πι κεφαλαίο τζί, και παρονομαστή σί στην τέταρτη, τέλος κλάσματος κεφαλαίο ταυ με κάτω δείκτες μι νι»
...
> «χι ίσον κλάσμα με αριθμητή μείον μπί συν πλην τετραγωνική ρίζα του μπί στο τετράγωνο πλην 4 έι σί, και παρονομαστή 2 έι, τέλος κλάσματος»
...
> Requires NVDA 2024.1 or later. Version **2.5.3** declares compatibility through NVDA 2026.1.1. Its Word final-speech filter, added in 2.0.0, is specific to NVDA 2026.1.1; older NVDA versions continue using the provider/TextInfo routes available to them.

> The current version (**2.5.3**) ships on the stable channel by explicit maintainer decision. Review gates for the semantic terminology and optional neural voices remain open — see [RELEASE_GATES.md](RELEASE_GATES.md), [TERMINOLOGY_REVIEW.md](TERMINOLOGY_REVIEW.md), and [TTS_ENGINE_RESEARCH.md](TTS_ENGINE_RESEARCH.md).
...
| − (sign) | μείον | negative |
| × · | επί | times |
| * (standalone) | αστερίσκος | asterisk |
| ÷ / | διά | divided by |
| = | ίσον | equals |
...
| Expression | Spoken in Greek | (meaning) |
|---|---|---|
| dy/dx | παράγωγος του γουάι ως προς χι | derivative of y with respect to x |
| ∂f/∂x | μερική παράγωγος του εφ ως προς χι | partial derivative of f with respect to x |
| f′(x) | εφ τόνος του χι | f prime of x |
| ∫₀¹ x² dx | ολοκλήρωμα από 0 έως 1 του χι στο τετράγωνο ως προς χ | integral from 0 to 1 of x² dx |
...
| ℝⁿ | πραγματικός χώρος νι διαστάσεων | real vector space of dimension n |
| 30° 15′ | 30 μοίρες 15 πρώτα λεπτά | 30 degrees 15 arc minutes |
| A⃗Β | διάνυσμα άλφα βήτα | vector AB |
| Aᵀ | ανάστροφος του έι | transpose of A |
...
| Expression | Spoken in Greek | Meaning |
|---|---|---|
| ∇f | ανάδελτα του εφ | gradient of f |
| ∇·F | απόκλιση του εφ | divergence of F |
| ∇×F | στροβιλισμός του εφ | curl of F |
| ∇²f | λαπλασιανή του εφ | Laplacian of f |
| **a**·**b** | εσωτερικό γινόμενο έι με μπί | inner/dot product |
| `cross-product(a,b)` with `intent` | διανυσματικό γινόμενο έι με μπί | vector cross product |
| `exterior-product(a,b)` with `intent` | εξωτερικό γινόμενο έι με μπί | exterior product |
| `tensor-product(a,b)` with `intent` | τανυστικό γινόμενο έι με μπί | tensor product |
...
| E[X \| Y] | δεσμευμένη αναμενόμενη τιμή του χι δεδομένου του γουάι | conditional expectation |
| X ⫫ Y | χι ανεξάρτητο από γουάι | X is independent of Y |
| P(A \| B) | πιθανότητα του έι δεδομένου του μπί | conditional probability |
| Var(X) | διακύμανση του χι | variance of X |
| Cov(X,Y) | συνδιακύμανση των χι και γουάι | covariance of X and Y |
...
|---|---|---|
| A†, Standard profile | συζυγής ανάστροφος του έι | conjugate transpose |
| A†, University profile | προσαρτημένος τελεστής του έι | adjoint operator |
| A†, Quantum context | ερμιτιανός συζυγής του έι | Hermitian adjoint |
| ⟨ψ\|φ⟩ | εσωτερικό γινόμενο ψι με φι | bra–ket inner product |
| ⟨ψ\|H\|φ⟩ | στοιχείο πίνακα με μπρα ψι έιτς κετ φι | matrix element |
| [x,p] = iℏ, Quantum context | μεταθέτης των χι και πι ίσον άι ας μπαρ | canonical commutator |
...
|---|---|---|
| `eigenvalue(A)` | ιδιοτιμή του έι | eigenvalue of A |
...
| `bounded-operator(A)` | φραγμένος τελεστής έι | bounded operator A |
